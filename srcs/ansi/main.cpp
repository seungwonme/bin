...
static void printColorTable(void)
{
    cout << left << setw(TYPE) << "Type" << setw(CODE) << "Code" << setw(COLOR) << "Color" << '\n'
...
static void printGrammar(void)
{
    cout << "Format : " << "<escape>" << "\033[37m" << '[' << "\033[0m" << "[<style>;]" << "<color>" << "\033[37m" << 'm' << "\033[0m" << "\n"
...
static void printHelp(void)
{
    cout << "Usage: ansi [options]\n"
         << "Options:\n"
         << "  -t, --table     Print the color table\n"
         << "  -g, --grammar   Print the grammar for ANSI escape codes\n"
